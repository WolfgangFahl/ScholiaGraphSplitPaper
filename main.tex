...
%% The abstract
\begin{abstract}
\comment{If Hannah is listed as an author, her mentions in the text and in the acknowledgments should be adjusted accordingly}
...
official Wikidata Query Service SPARQL 1.1. compliant, too. If, contrary to current
expectations, that service does not use QLever, the Scholia queries may need some further adjustments. 
